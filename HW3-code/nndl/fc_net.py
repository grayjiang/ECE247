...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None):
    ...
    N = X.shape[0]
    X = X.reshape(N, -1)
    out_relu, cache_relu = affine_relu_forward(X, W1, b1)
    scores, cache_scores = affine_forward(out_relu, W2, b2)
    # ================================================================ #
    # END YOUR CODE HERE
    # ================================================================ #
    ...
    grads = {}
    dx1, dW2,  grads["b2"] = affine_backward(dscores, cache_scores)
    grads["W2"] = dW2 + self.reg * W2
    
    dx, dW1, grads["b1"] = affine_relu_backward(dx1, cache_relu)
